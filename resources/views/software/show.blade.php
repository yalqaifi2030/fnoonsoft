                ...
                <div id="live" data-spy class="card-luxury p-6 scroll-mt-32" x-data="{ run: false }">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <div class="relative w-[380px] max-w-full">
                            <div class="relative rounded-[2.8rem] border-[12px] border-luxury-black bg-luxury-black shadow-2xl overflow-hidden" style="aspect-ratio: 9 / 19.5;">
                                {{-- notch --}}
                                ...
                                <button type="button" x-show="!run" @click="run = true"
                                        class="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 rounded-[1.9rem] bg-gradient-to-br from-saudi-green to-saudi-green-dark text-white">
