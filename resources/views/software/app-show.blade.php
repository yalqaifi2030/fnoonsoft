    ...
    <div class="mx-auto grid max-w-7xl gap-8 px-4 py-12 lg:grid-cols-3">
        <div class="space-y-10 lg:col-span-2">
            ...
            @if (! empty($software->copy_blocks))
                <section class="card-luxury p-6">
                    <h2 class="mb-4 flex items-center gap-2 font-cairo text-xl font-black text-luxury-black">
                    ...
                    <div class="space-y-4">
                        @foreach ($software->copy_blocks as $block)
                            ...
                            @if ($content !== '')
                                <div x-data="{ c: false }">
                                    @if ($label !== '')<p class="mb-1.5 text-sm font-semibold text-gray-700">{{ $label }}</p>@endif
                                    <div class="flex items-stretch gap-2">
                                        ...
                                        <button type="button" @click="window.fnoonCopy(@js($content)); c = true; setTimeout(() => c = false, 1500)"
