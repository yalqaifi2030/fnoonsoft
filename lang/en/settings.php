...
return [
    ...
    'nudge' => [
        ...
        'enabled_hint' => 'Shows a gentle toast on every download (on the download page) encouraging visitors to rate the site, then auto-hides. Repeats each download.',
        'gate_section' => 'Rate-before-download gate',
        'gate_enabled' => 'Require a star rating before download',
        'gate_hint' => 'Locks the download button until the visitor taps one star (a single tap unlocks it instantly). Visitors who already rated aren’t asked again. Turn off for direct downloads.',
        'text_section' => 'Text',
        ...
        'delay_hint' => 'How many seconds after the download starts before the toast appears.',
    ...
    'watermark' => [
        ...
        'opacity' => 'Opacity',
        'opacity_hint' => 'Higher = sharper / more visible (10–95%). ~50% recommended.',
        'size' => 'Text size',
        'size_hint' => 'Percent of the image width (2–14%).',
